 ...
 */
final class Version20220111141712 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE advert (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, creation_date DATETIME NOT NULL, update_date DATETIME NOT NULL, end_date DATETIME NOT NULL, brand VARCHAR(255) DEFAULT NULL, use_condition VARCHAR(255) NOT NULL, INDEX IDX_54F1F40B7E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
